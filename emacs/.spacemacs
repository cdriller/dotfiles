...
(require 'eaf) (require 'eaf-pdf-viewer)
  )
  ...
  (custom-set-variables
   ...
   '(package-selected-packages
     '(ace-link aggressive-indent all-the-icons auto-compile auto-highlight-symbol
                ...
                disable-mouse dotenv-mode drag-stuff dumb-jump eaf elisp-def
                ...
                evil-visualstar expand-region eyebrowse fancy-battery gnuplot
