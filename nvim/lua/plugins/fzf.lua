return {
    ...
    keys = {
        { "<leader>b",       function () require("fzf-lua").buffers() end,    mode = "n", noremap = true, silent = true },
        { "<leader>e",       function () require("fzf-lua").files() end,    mode = "n", noremap = true, silent = true },
